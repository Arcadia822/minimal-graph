...
```bash
cp -r minimal-editorial-visuals ~/workspace/skills/
```

Then ask your agent to use `minimal-editorial-visuals` when creating WeChat visuals, Xiaohongshu cards, or deterministic editorial infographics.
