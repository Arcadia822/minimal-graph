...
- Local guide `/Users/arcadia/.agents/skills/writing-skills/SKILL.md`: used to review skill structure, description cleanup, and the separation between core rendering rules and channel-specific addons.
